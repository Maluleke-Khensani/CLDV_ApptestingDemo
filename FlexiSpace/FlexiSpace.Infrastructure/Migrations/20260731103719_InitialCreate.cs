        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Boardrooms_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationCalendarAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LocationCalendarAccounts_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardroomEquipment", x => new { x.BoardroomId, x.EquipmentId });
                    table.ForeignKey(
                        name: "FK_BoardroomEquipment_Boardrooms_BoardroomId",
                        column: x => x.BoardroomId,
                        principalTable: "Boardrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardroomEquipment_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingCatering", x => new { x.BookingId, x.CateringId });
                    table.ForeignKey(
                        name: "FK_BookingCatering_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingCatering_Caterings_CateringId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingEquipment", x => new { x.BookingId, x.EquipmentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardroomEquipment_EquipmentId",
                table: "BoardroomEquipment",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Boardrooms_LocationId",
                table: "Boardrooms",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingCatering_CateringId",
                table: "BookingCatering",
                column: "CateringId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationCalendarAccounts_LocationId",
                table: "LocationCalendarAccounts",
                column: "LocationId");
